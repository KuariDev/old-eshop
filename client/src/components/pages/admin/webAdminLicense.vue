    ...
    <div class="admin-wrap">
        ...
        <div class="admin-login">
          <router-link to="api/license/download" class="login-button export-button" target="_blank" style="margin: 0px 0px 15px 0px; text-decoration: none; color: white; display: inline-flex; top: 25px; right: 25px; position: absolute;">
            ...
            <div class="login-label">Добавление лицензий</div>
            <textarea v-bind:class="{ errorRedInput: licenseError, successGreenInput: successAddLicense }" class="login-input" placeholder="Лицензия,Имя товара" v-model="license" style="height: 150px; resize: none;"></textarea>
        ...
        async addLicense() {
            if (this.license === "") {
                ...
                try {
                    ...
                    const response = await axios.post('license/solo', {
                        licenses: licenses
                    }, {  headers: headers  })
